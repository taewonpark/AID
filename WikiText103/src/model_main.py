...
from utils.AID import CudaFastWeightLinearAIDTransformerLayer
from utils.AID import CudaFastWeightSumLinearAIDTransformerLayer

#CudaFastWeightLinearAIDTransformerLayer
#CudaFastWeightSumLinearAIDTransformerLayer
...
class DecoderLayer(nn.Module):
    def __init__(self, n_head, d_model, d_head, d_inner, dropout, attn_type,
        ...
        if attn_type == 2:
            ...
            attn_func = CudaFastWeightSumLinearAIDTransformerLayer
        elif attn_type == 9999:
            attn_func = CudaFastWeightLinearAIDTransformerLayer
        else:
                ...
                if i % self.n_decomposition_layer == 0:
                    ...
                    self.layers.append(
                        DecoderLayer(
                            ...
                            use_out_proj=(not remove_out_proj),
                            d_res=self.d_res,
                            attn_type=24, layer_id=i, num_layer=n_layer,
                            skip_attn_normalization=skip_attn_normalization)
                    )
